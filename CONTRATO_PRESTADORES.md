...
Este contrato aplica, entre otros, a los siguientes servicios:

- 🚐 **Transporte turístico**
- 🗺️ **Tours y recorridos guiados**
- 🎢 **Atracciones turísticas**
- 🌿 **Experiencias culturales, rurales o gastronómicas**
- 🧑‍🏫 **Servicios de guianza turística**
- 🏃 **Actividades recreativas o de aventura**
...
1. Cumplir la **normativa turística colombiana vigente**, incluyendo la **Ley 2068 de 2020**, normas complementarias y las que entren en vigor hacia 2026.

2. Garantizar que cuenta con **autorizaciones, licencias, seguros y permisos** requeridos para su actividad.

3. Proveer **información veraz, actualizada y comprobable**.

4. Cumplir **estándares de seguridad, higiene, atención al turista** y gestión de riesgos.

5. Asumir toda **responsabilidad civil, penal, administrativa y tributaria** derivada del servicio.

6. Aceptar procesos de **validación documental mediante IA** y revisión humana.
...
- Información falsa
- Conductas que afecten la reputación de la plataforma
...
EL PRESTADOR autoriza el uso de datos para:
...
## 13. ACEPTACIÓN DIGITAL Y FIRMA

Este contrato se acepta mediante:

✔ Check digital  
✔ Firma electrónica  
✔ Registro de IP, fecha, hora y hash

📌 El documento se genera automáticamente en **PDF**, se almacena en **Supabase Storage** y queda disponible en el panel del prestador.
...
Cualquier controversia se someterá a la **jurisdicción colombiana**.

---

## ✍️ ACEPTACIÓN ELECTRÓNICA

El PRESTADOR declara haber leído, comprendido y aceptado este contrato en su totalidad.
